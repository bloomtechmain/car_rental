...
export const createVehicle = async (req, res) => {
    ...
    try {
        const newVehicle = await pool.query(`INSERT INTO vehicles (owner_id, make, model, year, license_plate, price_per_day, location, image_url, description, list_availability)
